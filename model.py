...
#import tensorflow.keras as keras  #my addition
import tensorflow
...
def green_block(inp, filters, data_format='channels_first', name=None):
    ...
    `data_format`: string, optional
        The format of the input data. Must be either 'channels_first' or
    ...
    x = GroupNormalization(
        ...
        name=f'GroupNorm_1_{name}' if name else None)(inp)  ##it was nname else None
...
def build_model(input_shape=(4, 160, 192, 128), output_channels=3, weight_L2=0.1, weight_KL=0.1, dice_e=1e-8):
    ...
    model.compile(
        adam(lr=lrn), #lrn=1e-4 (default value)
