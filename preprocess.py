...
data_path = ['/home/superteam/test/raw_data/MICCAI_BraTS_2018','/home/superteam/test/raw_data/BRATS_2019', '/home/azach/superteam/raw_data/BRATS_2020']
saving_path='/home/superteam/test/data'



patients = os.listdir(data_path[0])
print(patients)
...
#     plt.figure()
#     plt.imshow(data[i, 0, :, :, 50], cmap='gray')
#     plt.savefig("xaxa.png")
#     plt.close()
#     plt.figure()
#     plt.imshow(data[i, 1, :, :, 50], cmap='gray')
#     plt.savefig("xaxa1.png")
#     plt.close()
#     plt.figure()
#     plt.imshow(data[i, 2, :, :, 50], cmap='gray')
#     plt.savefig("xaxa2.png")
#     plt.close()
#     plt.figure()
#     plt.imshow(data[i, 3, :, :, 50], cmap='gray')
#     plt.savefig("xaxa3.png")
#     plt.close()

#     plt.figure()
#     plt.imshow(labels[i, 0, :, :, 50], cmap='gray')
#     plt.savefig("xaxamask0.png")
#     plt.close()
#     plt.figure()
#     plt.imshow(labels[i, 1, :, :, 50], cmap='gray')
#     plt.savefig("xaxamask1.png")
#     plt.close()
