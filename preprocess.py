...
data_path = ['/media/nasia/ssd2tb/nasia/MICCAI_BraTS_2018']
saving_path='/media/nasia/ssd2tb/nasia/data'
...
nib.save(all_data, os.path.join(saving_path, 'data_one.nii.gz'))
nib.save(all_lab, os.path.join(saving_path,'labels_one.nii.gz'))
